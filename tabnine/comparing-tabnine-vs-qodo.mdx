...
[
    ...
    ['Pricing', 'Free tier + Enterprise $39/mo', 'Free, Team $19/mo, Enterprise']
]
...
- **Enterprise Plans**:
  - **SaaS Version**: Cloud-based enterprise solution
  - **Private Installation**: On-premises deployment with maximum security

### Qodo Gen
- **Free Tier**: Access to basic features for individual developers
- **Pro Tier**: Enhanced functionality including AI-assisted code completion, targeted at teams and enterprises
